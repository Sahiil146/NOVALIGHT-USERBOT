...
from . import light_cmd, get_string, HNDLR, async_searcher


@light_cmd(pattern="joke$")
async def _(ult):
    await ult.eor(get_joke())


@light_cmd(pattern="url ?(.*)")
async def _(event):

...
#
#   Light UserBot Don't Need This Stuffs
#
...
from LightUB._misc._decorators import compile_pattern, light_cmd
...
ALIVE_NAME = light_bot.me.first_name
BOTLOG_CHATID = BOTLOG = udB.get_key("LOG_CHANNEL")


bot = borg = catub = friday = ultroid_bot = ultroid = light_bot
catub.cat_cmd = ultroid_cmd = light_cmd
...
class Config((object)):
    if ENV:
        ...
        TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "light")

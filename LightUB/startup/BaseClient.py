...
class LightClient(TelegramClient):
    def __init__(
        self,
        session,
        api_id=None,
    ...
    async def fast_uploader(self, file, **kwargs):
        ...
        from LightUB.fns.FastTelethon import upload_file
        from LightUB.fns.helper import progress
    ...
    async def fast_downloader(self, file, **kwargs):
        ...
        from LightUB.fns.FastTelethon import download_file
        from LightUB.fns.helper import progress

...
def load_addons(plugin_name):
    ...
    if base_name.startswith("__"):
        return
    from .. import HNDLR, LOGS, asst, udB, light_bot
    from .._misc import _supporter as xxx
    from LightUB import fns
    from .._misc._assistant import asst_cmd, callback, in_pattern
    from .._misc._decorators import light_cmd
    ...
    mod.asst = asst
    mod.tgbot = asst
    mod.light_bot = light_bot
    mod.ub = light_bot
    mod.bot = light_bot
    mod.light = light_bot
    mod.borg = light_bot
    mod.telebot = light_bot
    mod.jarvis = light_bot
    mod.friday = light_bot
    mod.eod = eod
    mod.edit_delete = eod
    mod.LOGS = LOGS
    ...
    mod.light_cmd = light_cmd
    mod.on_cmd = light_cmd

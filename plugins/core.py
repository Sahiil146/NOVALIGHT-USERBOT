...
from LightUB.startup.loader import load_addons

from . import LOGS, async_searcher, eod, get_string, safeinstall, light_cmd, un_plug


@light_cmd(pattern="install", fullsudo=True)
...
@light_cmd(pattern="getaddons( (.*)|$)", fullsudo=True)

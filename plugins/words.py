...
from LightUB.fns.misc import get_synonyms_or_antonyms
from LightUB.fns.tools import async_searcher

from . import get_string, light_cmd


@light_cmd(pattern="meaning( (.*)|$)", manager=True)

...
from LightUB.fns.helper import numerize
from LightUB.fns.misc import create_instagram_client
...
async def soon_(e):
    ...
    await e.reply(
        ...
        file=photo,
        force_document=True,
        attributes=[DocumentAttributeFilename("Instalight.jpg")],
    )
    await ew.delete()


@light_cmd(pattern="(instaul|reels|igtv)( (.*)|$)")

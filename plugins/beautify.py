...
from . import Carbon, eor, get_string, inline_mention, os, light_cmd
...
async def crbn(event):
    ...
    xx = await Carbon(code=code, file_name="light_carbon", backgroundColor=col)
    await xxxx.delete()
    await event.reply(

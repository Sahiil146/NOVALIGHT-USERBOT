...
from . import eod, eor, get_string, mediainfo, light_cmd
...
@light_cmd(pattern="setbio( (.*)|$)", fullsudo=True)
async def _(ult):
    ok = await ult.eor("...")
...
@light_cmd(pattern="setname ?((.|//)*)", fullsudo=True)
async def _(ult):
    ok = await ult.eor("...")
...
@light_cmd(pattern="setpic$", fullsudo=True)
async def _(ult):
    if not ult.is_reply:
...
@light_cmd(pattern="delpfp( (.*)|$)", fullsudo=True)

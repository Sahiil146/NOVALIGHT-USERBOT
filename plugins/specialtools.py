...
from LightUB.fns.google_image import googleimagesdownload
from LightUB.fns.tools import metadata
...
@light_cmd(pattern="q( (.*)|$)", manager=True, allow_pm=True)
async def quott_(event):
    ...
    message = await reply.reply("Quotly by light", file=file)
    os.remove(file)
    await msg.delete()
    return message

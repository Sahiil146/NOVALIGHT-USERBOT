...
def start():
    ...
    print(f"{a}\n\n")
    print("Welcome to light, lets start setting up!\n\n")
    print("Cloning the repository...\n\n")
    os.system("rm -rf light")
    os.system("git clone https://github.com/CodeWithTyagi/light.git")
    print("\n\nDone")
    os.chdir("light")
    clear_screen()
    print(a)
    ...
    all_done = "# Light Environment Variables.\n# Do not delete this file.\n\n"
    for i in varrs:
        all_done += do_input(i)
    clear_screen()
    print(a)
